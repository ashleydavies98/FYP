...
def app():
    ...
    def confidence():
        ...
        expander.info("Velocity  \n = Current motion(w) + Particle memory(c1) + swarm influence (c2)  \n"
                      ...
                      "resistance against changes in Velocity. Adjusting the value of Inertia also effects "
                      "how quickly Particle converge during optimisation. \n"
        ...
        st.write("As you can see, Confidence Parameters c1 and c2 refer to the influence of PBEST "
                 ...
                 "of either c1 or c2 higher than the other. Both c1 and c2 are constant throughout "
                 "optimisation, whereas Inertia (w) adapts to be weighted lower as Particles converge "
                 "to positions of optima/minima.")
    ...
    def searchPara():
        ...
        st.write("While each particle has its own variables and components, the search space "
                 ...
                 "space also has another variable that is updated with each iteration, which is Time(t).")
        st.info("-Number of iterations: The number of iterations that the algorithm will go through. With each "
                "iteration, the algorithm will try to improve the problem solution further.  \n"
                "  \n"
                ...
                "to determine what positions particles are in at particular points throughout optimisation "
                "and is incremented at each new iteration.")
        ...
        st.write("More iterations mean more Velocity updates and therefore, further optimisation. However by "
                 ...
                 "input and what finishing criteria should be used to achieve a satisfactory optimisation "
                 "result, but without wasting resources.")
