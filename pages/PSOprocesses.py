...
def app():
    ...
    def initialising():
        ...
        st.write("To give you more understanding of how PSO is initialised, here is a coded example "
                 "of a PSO algorithm.")
        ...
        st.write("Next, an instance of the swarm is created and stored within the 'swarm' variable, "
                 ...
                 "neighbourhood where they follow the particle with the best performance.  \n")
        ...
        with st.form("Processes form"):
            ...
            st.write("Previously, we discussed the effect of confidence parameters. Looking at the values of c1, "
                     "c2 in the above code, what parameter will influence Particle movement the most?")
    ...
    def optimising():
        ...
        st.write("When Particles start following BEST values towards an optimal solution, Particles begin to "
                 ...
                 "the fitness value of the given fitness function.")
    ...
    def convergence():
        ...
        st.write(
            "Converging of Particles towards an optimum. Convergence rate and the possibility of Convergence "
        ...
        st.write("Particles can explore in both an exploitative or explorative fashion, "
                 ...
                 "too early at a Global minimum solution, without "
        ...
        st.write("Typically, Particles will be more explorative at the initialisation of optimisation "
                 "as the Particles will have larger inertia and velocity values that allow them to explore the "
        ...
        expander3.write("Particles have an inertia value of 0.9, which means that they carry "
                        ...
                        "to discover a wider range of optimal positions and in fact, the particles here can't "
                        "converge quick enough, before the 'number of Iterations' stopping condition is met.")
